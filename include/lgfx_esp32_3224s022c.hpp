...
// 8ビットパラレルバスの設定
      ...
      cfg.pin_d0 = 15;              // D0を接続しているピン番号
      cfg.pin_d1 = 13;              // D1を接続しているピン番号
      cfg.pin_d2 = 12;              // D2を接続しているピン番号
      cfg.pin_d3 = 14;              // D3を接続しているピン番号
      cfg.pin_d4 = 27;              // D4を接続しているピン番号
      cfg.pin_d5 = 25;              // D5を接続しているピン番号
      cfg.pin_d6 = 33;              // D6を接続しているピン番号
      cfg.pin_d7 = 32;              // D7を接続しているピン番号
//
...
//*
    { // バックライト制御の設定を行います。（必要なければ削除）
      ...
      cfg.pin_bl = 0;              // バックライトが接続されているピン番号
